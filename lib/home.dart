  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Column(
        children: [
          Container(
            margin: EdgeInsets.fromLTRB(48, 48, 48, 8),
            height: 86,
            ...
            children: [
              Row(
                ...
                children: [
                  GestureDetector(
                    onTap: () async {
                      int timeBack = await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder:
          ...
          Container(
            height: 86,
            margin: EdgeInsets.symmetric(horizontal: 48, vertical: 48),
            width: MediaQuery.of(context).size.width,
            alignment: Alignment.center,
            decoration: BoxDecoration(
              color: Colors.deepOrangeAccent,
